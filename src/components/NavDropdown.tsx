...
const DEFAULT_AVATAR_URL =
    "https://firebasestorage.googleapis.com/v0/b/x-next-e5030.appspot.com/o/default%20profile.png?alt=media&token=30c25630-f81e-41a3-97c3-e531c4e66825";
                        ...
                        <Link href={`/dashboard/${session?.user._id}`}>
                            <div className="flex items-center gap-4 my-2">
                                ...
                                <div className="w-[70%] relative">
                                    ...
                                    {session?.user.role && (
                                      <span className="mt-1 mb-2 inline-block rounded bg-primary/20 px-2 py-0.5 text-xs font-medium text-primary">
                                        {session.user.role}
                                      </span>
                                    )}
