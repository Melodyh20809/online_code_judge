  ...
  return (
    <div className="w-[80%] px-4 border-l flex justify-between items-center h-full">
      <div className="flex items-center gap-2">
        <Link href="/problem/dummy-two-sum"><ListVideo className={`${theme === "dark" ? 'text-neutral-300' : ''} resize-custom w-5`} /></Link>
        <Link href="/problem/dummy-two-sum" className=''>Problem</Link>
